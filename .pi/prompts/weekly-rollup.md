...
**Writing style:** If any part of the roll-up will be shared or pasted (a Slack summary, a Notion update), read `.pi/skills/unslop-writing/SKILL.md` and apply it — no AI-default phrasing, no em-dashes. Pure internal bullet shorthand doesn't need it.
